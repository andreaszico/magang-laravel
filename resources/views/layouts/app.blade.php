        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    {{-- <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ route("article") }}">Home</a>
                    </li> --}}
                    <li class="nav-item">
                    ...
                    {{-- @if (Auth::check() && Auth::user()->role === "Admin")
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{ route("article_create") }}">Create Article</a>
                        </li>
                    @endif --}}
                </ul>
                <form class="d-flex">
